...
* **BLAKE3 hash function support** - [PQC Suite B](https://github.com/PQC-Suite-B/) (by JP Aumasson, co-creator of BLAKE3, and Zooko Wilcox-O'Hearn) demonstrates 60-80% of SLH-DSA time is hashing, with BLAKE3 significantly faster than SHAKE on x86 (SIMD parallelism). SLH-DSA's hash-agnostic architecture enables BLAKE3-instantiated parameter sets alongside SHA2/SHAKE for performance-sensitive deployments.
